...
const perceptionClient = createPerceptionClient({ api, shouldPoll: () => !document.hidden && ['sensors', 'cockpit'].includes(activePage) });
let cloudSeq = -1;
