...
_HTTP_EVENTS: tuple[tuple[str, re.Pattern[str], str], ...] = (
    ...
    ("POST", re.compile(r"^/api/v1/navigation/localization/start$"), "localization_start"),
    ("POST", re.compile(r"^/api/v1/navigation/localization/stop$"), "localization_stop"),
    ("POST", re.compile(r"^/api/v1/navigation/localization/initial-pose$"), "localization_initial_pose"),
    ...
    ("POST", re.compile(r"^/api/v1/competition/lock$"), "competition_lock"),
    ("POST", re.compile(r"^/api/v1/competition/unlock$"), "competition_unlock"),
    ("POST", re.compile(r"^/api/v1/competition/mode$"), "competition_mode"),
    ("POST", re.compile(r"^/api/v1/route-planner/guidance/start$"), "route_guidance_start"),
    ("POST", re.compile(r"^/api/v1/route-planner/guidance/stop$"), "route_guidance_stop"),
    ("POST", re.compile(r"^/api/v1/route-planner/guidance/pickup$"), "route_pickup_confirm"),
    ("POST", re.compile(r"^/api/v1/route-planner/guidance/dropoff$"), "route_dropoff_confirm"),
