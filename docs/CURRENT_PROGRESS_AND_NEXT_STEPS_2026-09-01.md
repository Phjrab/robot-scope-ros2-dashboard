...
> 이 문서는 2026-09-01 시점의 기록입니다. 이후 정지 상태 관측,
> Nav2 command timeout, 합성 timing replay, 도식 수동 안내와 공간 경로 편집이
> 추가되었습니다. 최신 범위는 [README의 현재 검증 경계](../README.md)와
> 각 날짜별 후속 기록을 보세요. 아래 당시 `BLOCKED` 판정은 그대로 보존합니다.
